...
public class SettingsGUI : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (newUser)
        {
            ...
            brookeScale = GUI.HorizontalSlider(new Rect(scaledResolutionWidth / 2 - (textBoxWidth / 2), nativeVerticalResolution / 2 - 55, textBoxWidth, textBoxHeight), brookeScale, 1, 5);
